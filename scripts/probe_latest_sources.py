...
def crossref_kdd_probe(probe: dict[str, Any]) -> dict[str, Any]:
    event_name = "KDD '26: The 32nd ACM SIGKDD Conference on Knowledge Discovery and Data Mining"
    params = {
        "filter": "prefix:10.1145,type:proceedings-article,from-pub-date:2026-01-01,until-pub-date:2026-12-31",
        "query.event-name": "The 32nd ACM SIGKDD Conference on Knowledge Discovery and Data Mining",
        "rows": 1000,
        "cursor": "*",
    ...
    return {
        **probe,
        "status": "available" if relevant >= min_expected else "incomplete",
...
PROBES: list[dict[str, Any]] = [
    ...
    {"id": "kdd2026-crossref-acm", "venue_key": "kdd", "year": 2026, "kind": "crossref_kdd", "min_expected_count": 200},
...
def main() -> None:
    ...
    for probe in PROBES:
        ...
        elif kind == "crossref_kdd":
            results.append(crossref_kdd_probe(probe))
        else:
